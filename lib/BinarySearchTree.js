...
module.exports = class BinarySearchTree {
    ...
    // tru caso exista e false caso contrário
    search(key) {
        return this.searchNode(this.root, key)
    }

    // Verifica se existe algum nodo, a partir de uma dada raiz (root), que
    ...
    searchNode(root, key) {
        ...
        // Caso 4: key é igual ao data root
    ...
    // Caso 4: key é igual ao data do root (encontrou o nodo a ser removido)
        ...
        // Caso 4a: exclusão de nodo folha (grau 8)
    ...
    // Caso 4d: exclusão de nodo de grau 2
        ...
        // É preciso encontrar o nodo com o MAIOR valor de lado ESQUERDO ou
        ...
        // seu valor ja esta na raiz da subárvore e seu valor, neste 
